...
public class YonghuzhuceServerImpi implements YonghuzhuceServer {
   ...
   private YonghuzhuceMapper gdao;
	...
	@Override
	public int insertYonghu(Yonghu yonghu) {
		return gdao.insertYonghu(yonghu);
	}

	@Override
	public Yonghu selectYonghu(Map<String, Object> map) {
		return gdao.selectYonghu(map);
	}

	@Override
	public Fangyuanxinxi selectGuanzhufangyuan(String bianhao) {
		return gdao.selectGuanzhufangyuan(bianhao);
	}

	@Override
	public Yonghu selectBuUsername(String username) {
		
		return gdao.selectBuUsername(username);
	}

	@Override
	public List<String> selectBianhao(Map<String, Object> map) {
		return gdao.selectBianhao(map);
	}

	@Override
	public int selecCounttBianhao(String ufid) {
		return gdao.selecCounttBianhao(ufid);
	}
