...
<c:choose>
<c:when test="${flag=='ok'}">
<form action="updateFankui2.do" method="post">
	<div class="contain1">
  		<div class="contain2">
			<span class="input input--jiro">
					<input class="input__field input__field--jiro" type="text" name="bianhao" id="bianhao" value="${Fankui.bianhao}" />
	...
	<div class='textarea-wrapper'>
        <div class='textarea-block'>
            <textarea class="textarea-item" name="content" placeholder="请输入内容，不超过300字。" maxlength="300" spellcheck="false">${Fankui.feedback}</textarea>
...
<c:otherwise>
<form action="updateFankui1.do" method="post">
	<div class="contain1">
  		<div class="contain2">
			<span class="input input--jiro">
...
<!-- input框需要的js -->
<script type="text/javascript" src="js/Kanfangfankui_update.js"></script>
</body>
</html>